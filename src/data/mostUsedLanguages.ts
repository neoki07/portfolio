export const mostUsedLanguages = [
  { name: 'TypeScript', totalSize: 588148, color: '#3178c6' },
  { name: 'Rust', totalSize: 315755, color: '#dea584' },
  { name: 'Python', totalSize: 209732, color: '#3572A5' },
  { name: 'Go', totalSize: 170348, color: '#00ADD8' },
  { name: 'JavaScript', totalSize: 91363, color: '#f1e05a' },
